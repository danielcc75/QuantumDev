...
<div id="modal-sugerir-categoria" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-[60] p-4" onclick="cerrarModalSugerirCategoriaFondo(event)">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md" onclick="event.stopPropagation()">
        <div class="bg-[#1e3a5f] text-white px-6 py-4 flex items-center justify-between rounded-t-2xl">
            <div>
                <h3 class="text-lg font-bold">Sugerir Categoría</h3>
                <p class="text-blue-200 text-xs mt-0.5">Ayúdanos a mejorar el catálogo</p>
            </div>
        ...
        <div class="p-6">
            <form id="formSugerirCategoria">
                <div class="mb-4">
                    <label class="block text-xs font-medium text-gray-700 mb-1">Título de la Categoría <span class="text-red-500">*</span></label>
                    <input type="text" id="sugerir_titulo" name="titulo" placeholder="Ej: Bases de Datos NoSQL" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
                <div class="mb-6">
                    <label class="block text-xs font-medium text-gray-700 mb-1">Descripción corta <span class="text-red-500">*</span></label>
                    <textarea id="sugerir_descripcion" name="descripcion" rows="3" placeholder="Por qué deberíamos agregar esta categoría..." class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"></textarea>
                </div>
                <div class="flex gap-3 pt-4 border-t border-gray-100">
                    <button type="button" onclick="cerrarModalSugerirCategoria()" class="flex-1 px-4 py-2 text-sm border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition">Cancelar</button>
